...
ClassBodyNode c = null;
      try {
        ...
        case PROTECTED:
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case PUBLIC:
            a = jj_consume_token(PUBLIC);
            break;
          case PRIVATE:
            a = jj_consume_token(PRIVATE);
            break;
          case PROTECTED:
            a = jj_consume_token(PROTECTED);
            break;
          default:
            jj_la1[2] = jj_gen;
            jj_consume_token(-1);
        ...
        c = classbody(g);
     {if (true) return new ClassDeclNode(a, t, n, e1, c);}
      } catch (ParseException e) {
...
RecoverySet f2 = new RecoverySet(SEMICOLON).union(g).remove(IDENT),
     ...
     {if (true) return new ClassBodyNode(t, c, v, as, ct, m);}
      } catch (ParseException e) {
...
//duvida
  final public VarDeclNode vardecl(RecoverySet g) throws ParseException, ParseEOFException {
    ...
    {if (true) return new VarDeclNode(a, b, t1, l);}
      } catch (ParseException e) {
...
MethodBodyNode m = null;
      try {
        ...
        m = methodbody(g);
         {if (true) return new ConstructDeclNode(a, t, m);}
      } catch (ParseException e) {
...
PrimitiveTypeNode c = null;
      try {
        ...
        t2 = jj_consume_token(IDENT);
        m = methodbody(g);
        {if (true) return new MethodDeclNode(a, b, t1, k, t2, m);}
      } catch (ParseException e) {
    ...
    try {
      ...
      try {
        ...
        while (true) {
          ...
          a = jj_consume_token(DOT);
          b = jj_consume_token(IDENT);
                                 e1 = new DotNode(a, e1, b);
        }
        jj_consume_token(LPAREN);
        l = paramlist(f1);
        jj_consume_token(RPAREN);
          {if (true) return new MethodCallNode(e1, l);}
      } catch (ParseException e) {
...
RecoverySet f1 = new RecoverySet(SEMICOLON).union(g),
  ...
  final public WhileNode whilestat(RecoverySet g) throws ParseException, ParseEOFException {
    ...
    try {
      ...
      try {
        ...
        jj_consume_token(RPAREN);
        s = statement(g);
          {if (true) return new WhileNode(a, e1, s);}
      } catch (ParseException e) {
  ...
  final public SwitchNode switchstat(RecoverySet g) throws ParseException, ParseEOFException {
    ...
    try {
        ...
        ListNode l = null;
        StatementNode s = null;
      a = jj_consume_token(SWITCH);
      jj_consume_token(LPAREN);
      b = jj_consume_token(IDENT);
      jj_consume_token(RPAREN);
      c = jj_consume_token(LBRACE);
      label_13:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case CASE:
      ...
      jj_consume_token(RBRACE);
          {if (true) return new SwitchNode(a, b, c, l);}
    throw new Error("Missing return statement in function");
    } finally {
    ...
    try {
      ...
      try {
        ...
        while (true) {
          ...
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case XOR:
            b = jj_consume_token(XOR);
            break;
          case OR:
            b = jj_consume_token(OR);
            break;
          case AND:
            b = jj_consume_token(AND);
            break;
          default:
            jj_la1[45] = jj_gen;
            jj_consume_token(-1);
...
MethodCallNode m = null;
      ...
      case double_constant:
        ...
        break;
      case byte_constant:
        t = jj_consume_token(byte_constant);
                             e = new ByteConstNode(t);
        break;
      case short_constant:
...
RecoverySet f =  new RecoverySet(COMMA).union(g);
  ...
  final public PrimitiveTypeNode primitivetype(RecoverySet g) throws ParseException, ParseEOFException {
    ...
    try {
      ...
      case CHAR:
        ...
        break;
      case DOUBLE:
        a = jj_consume_token(DOUBLE);
        break;
      case BYTE:
        a = jj_consume_token(BYTE);
        break;
      case SHORT:
        a = jj_consume_token(SHORT);
        break;
      case LONG:
        a = jj_consume_token(LONG);
        break;
      case FLOAT:
      ...
      default:
        ...
        throw new ParseException();
          ...
          {if (true) return new PrimitiveTypeNode(a);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  private boolean jj_3R_52() {
    ...
    if (jj_3R_63()) {
    jj_scanpos = xsp;
    if (jj_3R_64()) { if (!jj_rescan) trace_return("factor(LOOKAHEAD FAILED)"); return true; }
    }
    }
    }
    }
  ...
  private boolean jj_3R_60() {
    if (jj_scan_token(long_constant)) return true;
    return false;
  }

  private boolean jj_3R_59() {
    if (jj_scan_token(short_constant)) return true;
    return false;
  }
  ...
  private boolean jj_3R_58() {
    if (jj_scan_token(byte_constant)) return true;
    return false;
  }

  private boolean jj_3R_57() {
    if (jj_scan_token(double_constant)) return true;
    return false;
  }
